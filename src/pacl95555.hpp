...
#define CONFIG_PCAL95555_PORT0_PULL_UP                                         \
  ((CONFIG_PCAL95555_P0_0_PULL_UP << 0) |                                      \
   (CONFIG_PCAL95555_P0_1_PULL_UP << 1) |                                      \
   (CONFIG_PCAL95555_P0_2_PULL_UP << 2) |                                      \
   (CONFIG_PCAL95555_P0_3_PULL_UP << 3) |                                      \
   (CONFIG_PCAL95555_P0_4_PULL_UP << 4) |                                      \
   (CONFIG_PCAL95555_P0_5_PULL_UP << 5) |                                      \
   (CONFIG_PCAL95555_P0_6_PULL_UP << 6) |                                      \
   (CONFIG_PCAL95555_P0_7_PULL_UP << 7))
#endif
#ifndef CONFIG_PCAL95555_PORT1_PULL_UP
#define CONFIG_PCAL95555_PORT1_PULL_UP                                         \
  ((CONFIG_PCAL95555_P1_0_PULL_UP << 0) |                                      \
   (CONFIG_PCAL95555_P1_1_PULL_UP << 1) |                                      \
   (CONFIG_PCAL95555_P1_2_PULL_UP << 2) |                                      \
   (CONFIG_PCAL95555_P1_3_PULL_UP << 3) |                                      \
   (CONFIG_PCAL95555_P1_4_PULL_UP << 4) |                                      \
   (CONFIG_PCAL95555_P1_5_PULL_UP << 5) |                                      \
   (CONFIG_PCAL95555_P1_6_PULL_UP << 6) |                                      \
   (CONFIG_PCAL95555_P1_7_PULL_UP << 7))
#endif
...
#define CONFIG_PCAL95555_INIT_PULL_ENABLE                                      \
  ((CONFIG_PCAL95555_PORT1_PULL_ENABLE << 8) |                                 \
   CONFIG_PCAL95555_PORT0_PULL_ENABLE)
#endif
...
public:
  ...
  public:
     ...
     * error.
     */
    virtual bool write(uint8_t addr, uint8_t reg, const uint8_t *data,
                       size_t len) = 0;
    /**
