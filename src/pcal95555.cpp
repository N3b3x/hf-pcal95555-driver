...
PACL95555::PACL95555(PACL95555::i2cBus *bus, uint8_t address) : i2c_(bus), devAddr_(address) {}
...
void PACL95555::initFromConfig() {
  ...
  writeRegister(PACL95555_REG::OUTPUT_PORT_0, uint8_t(CONFIG_PCAL95555_INIT_OUTPUT & 0xFF));
  writeRegister(PACL95555_REG::OUTPUT_PORT_1, uint8_t((CONFIG_PCAL95555_INIT_OUTPUT >> 8) & 0xFF));

  writeRegister(PACL95555_REG::CONFIG_PORT_0, uint8_t(CONFIG_PCAL95555_INIT_DIRECTION & 0xFF));
  writeRegister(PACL95555_REG::CONFIG_PORT_1,
                uint8_t((CONFIG_PCAL95555_INIT_DIRECTION >> 8) & 0xFF));

  writeRegister(PACL95555_REG::PULL_ENABLE_0, uint8_t(CONFIG_PCAL95555_INIT_PULL_ENABLE & 0xFF));
  writeRegister(PACL95555_REG::PULL_ENABLE_1,
                uint8_t((CONFIG_PCAL95555_INIT_PULL_ENABLE >> 8) & 0xFF));

  writeRegister(PACL95555_REG::PULL_SELECT_0, uint8_t(CONFIG_PCAL95555_INIT_PULL_UP & 0xFF));
  writeRegister(PACL95555_REG::PULL_SELECT_1, uint8_t((CONFIG_PCAL95555_INIT_PULL_UP >> 8) & 0xFF));
