...
function initSearch() {
  ...
  request.open('GET', '/hf-pcal95555-driver/development/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/hf-pcal95555-driver/development/assets/css/just-the-docs-' + theme + '.css');
}
